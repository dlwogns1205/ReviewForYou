from functions import lets_do_crawling, keyword_in_review, sss, DNN_func, return_review_data, \
    result_of_selected_review_s_same_reviews
...
def product_detail(request, id):
    ...
    positive_comments = [c for c in all_comments if c.score >= 8]
    negative_comments = [c for c in all_comments if c.score <= 3]
